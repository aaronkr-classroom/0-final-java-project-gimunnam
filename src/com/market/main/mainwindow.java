...
public class mainwindow extends JFrame{
	...
	public mainwindow(String title, int x, int y, int width, int height) {
		...
		setIconImage(new ImageIcon("./images/sho/png").getImage());
	}
	...
	private void menuIntroduction() {
		...
		JButton btn1 = new JButton("고객 정보 확인하기",
				new ImageIcon("./images/1.png"));
		btn1.setBounds(0,0,100,50);
		btn1.setFont(ft);
		mMenuPanel.add(btn1);
		
		JButton btn2 = new JButton("장바구니 상품 목록 보기",
				new ImageIcon("./images/2.png"));
		btn1.setBounds(0,0,100,30);
		btn1.setFont(ft);
		mMenuPanel.add(btn2);
		
		JButton btn3 = new JButton("장바구니 비우기",
				new ImageIcon("./images/3.png"));
		btn1.setBounds(0,0,100,30);
		btn1.setFont(ft);
		mMenuPanel.add(btn3);
		
		JButton btn4 = new JButton("장바구니에 항목 추가하기",
				new ImageIcon("./images/4.png"));
		btn1.setFont(ft);
		mMenuPanel.add(btn4);
		
		JButton btn5 = new JButton("장바구니의 항목 수량 줄이기",
				new ImageIcon("./images/5.png"));
		btn1.setFont(ft);
		mMenuPanel.add(btn5);
		
		JButton btn6 = new JButton("장바구니의 항목 삭제하기",
				new ImageIcon("./images/6.png"));
		btn1.setFont(ft);
		mMenuPanel.add(btn6);
		
		JButton btn7 = new JButton("주문하기",
